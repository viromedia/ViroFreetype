...
CC           := clang --sysroot /Users/radvani/Source/ndk-toolchain/android-23/sysroot
COMPILER_SEP := $(SEP)
...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -march=armv7-a  -I/usr/local/Cellar/libpng/1.6.32/include/libpng16 -DFT_CONFIG_CONFIG_H="<ftconfig.h>"
...
# Linker flags.
#
LDFLAGS           := -L/usr/lib -llog -march=armv7-a -lz -L/usr/local/Cellar/libpng/1.6.32/lib -lpng16
