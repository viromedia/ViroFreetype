...
MKINSTALLDIRS   := /Users/radvani/Source/ViroFreetype/android/freetype-2.9/builds/unix/./install-sh -c -d
...
#
prefix       := /Users/radvani/Source/ViroFreetype/android/build/armeabi-v7a
exec_prefix  := ${prefix}
...
PKG_CONFIG         := 
REQUIRES_PRIVATE   := 
LIBS_PRIVATE       := -lz -L/usr/local/Cellar/libpng/1.6.32/lib -lpng16 -lz
LIBSSTATIC_CONFIG  := -lfreetype -lz -L/usr/local/Cellar/libpng/1.6.32/lib -lpng16 -lz
build_libtool_libs := 
ft_version         := 22.0.16
